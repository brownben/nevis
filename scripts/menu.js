...
module.exports.navigatePage = function (page) {
    if (page === 'Welcome') {
        document.getElementById('menu-welcome').setAttribute('style', 'display:block')
        document.getElementById('welcome').setAttribute('style', 'display:grid')
        ...
        document.getElementById('menu-welcome').setAttribute('style', 'display:none')
        ...
        document.getElementById('home').setAttribute('style', 'display:none')
        document.getElementById('download').setAttribute('style', 'display:grid')
    }
        ...
        document.getElementById('menu-back').setAttribute('style', 'display:block')
        document.getElementById('home').setAttribute('style', 'display:none')
        document.getElementById('entries').setAttribute('style', 'display:grid')
        document.getElementById('entries-info').setAttribute('style', 'display:none')
        document.getElementById('entries-search').setAttribute('style', 'display:grid')
        ...
        document.getElementById('home').setAttribute('style', 'display:none')
        document.getElementById('courses').setAttribute('style', 'display:grid')
        document.getElementById('courses-overview').setAttribute('style', 'display:grid')
