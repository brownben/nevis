...
<template>
  ...
  >
    ...
    >
      ...
      <p
        v-if="listOfRecords.length > 5"
        class="select-none"
      >
        More Than 5 Records Were Found - Only the First 5 Are Displayed. Please Try Narrowing Your Criteria
      </p>
...
export default {
  ...
  methods: {
    ...
    calculateAgeClass: (gender, ageClass) => ageClassFunctions(gender, ageClass),
  },
}
</script>
