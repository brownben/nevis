<template>
  ...
  >
    <div
      class="-mt-16 bg-white justify-around content-center flex-none my-shadow-lg mx-12 sm:mx-16 md:mx-20 lg:mx-32 xl:mx-40 px-3 pt-2 pb-3 text-center select-none"
    >
      <h1>{{ heading }}</h1>
