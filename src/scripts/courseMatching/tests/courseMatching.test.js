...
test('Find Best Course', () => {
  ...
  expect(courseMatching.findBestCourse([], [{ name: 'Long' }]))
    .toEqual({ name: 'Long', percentageMatch: 1 })
  expect(courseMatching.findBestCourse([], [{ name: 'Long' }]))
    .toEqual({ name: 'Long', percentageMatch: 0.5 })
  expect(courseMatching.findBestCourse([], [{ name: 'Long' }, { name: 'Short' }]))
  ...
  expect(courseMatching.findBestCourse([], []))
    .toEqual(undefined)
})
