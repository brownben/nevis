...
test('Display Actual Time', () => {
  ...
  expect(time.displayActualTime('MS')).toBe('MS')
  expect(time.displayActualTime('MF')).toBe('MF')
  expect(time.displayActualTime('Test')).toBe('Test')
  expect(time.displayActualTime('MS W1 M2-3 MF')).toBe('MS W1 M2-3 MF')
})
