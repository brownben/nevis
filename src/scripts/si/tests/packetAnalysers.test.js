...
test('Packet Analysers', () => {
  ...
  expect(packetAnalysers.card5.inserted([0, 0xE5, 0x06, 4, 5, 6, 7, 8, 9, 10, 11, 12])).toBeTruthy()

  expect(packetAnalysers.card10.inserted([])).toBeFalsy()
  expect(packetAnalysers.card10.inserted([0, 0xE8, 0x06])).toBeFalsy()
  expect(packetAnalysers.card10.inserted([0, 0xE8, 0x06, 4, 5, 6, 7, 8, 9, 10, 11, 12])).toBeTruthy()
