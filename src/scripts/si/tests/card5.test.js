...
test('Process Punch', () => {
  expect(card5.processPunch([14, 0, 0], 0)).toEqual({
    controlCode: 14,
    time: 0,
  })
  expect(card5.processPunch([14, 0, 0], 0, '14')).toEqual({
    controlCode: '14',
    time: 0,
  })
  expect(card5.processPunch([14, 0, 0], 0, 'S')).toEqual({
    controlCode: 'S',
    time: 0,
  })
  expect(card5.processPunch([14, 0, 15], 0)).toEqual({
    controlCode: 14,
    time: 15,
  })
  expect(card5.processPunch([14, 1, 15], 0, '14')).toEqual({
    controlCode: '14',
    time: 271,
  })
  expect(card5.processPunch([14, 5, 255], 0, 'S')).toEqual({
    controlCode: 'S',
    time: 1535,
  })
})
...
test('Fix Punch Times', () => {
  ...
  expect(card5.fixPunchTimes([{ time: 0 }, { time: 101 }])).toEqual([
    { time: 0 },
    { time: 101 },
  ])
  expect(
    card5.fixPunchTimes([{ time: 0 }, { time: 101 }, { time: 452 }])
  ).toEqual([{ time: 0 }, { time: 101 }, { time: 452 }])
  expect(
    card5.fixPunchTimes([{ time: 0 }, { time: 452 }, { time: 101 }])
  ).toEqual([{ time: 0 }, { time: 452 }, { time: 43301 }])
  expect(card5.fixPunchTimes([{ time: 555 }, { time: 0 }])).toEqual([
    { time: 555 },
    { time: 43200 },
  ])
})
